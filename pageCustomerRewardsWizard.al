    ...
    layout
    {
        area(Content)
        {
            group(MediaStandart)
            {
                ...
                field("MediaResourcesStandard.""Media Reference""";
                MediaResourcesStandard."Media Reference")
                {
                    ApplicationArea = All;
                    Editable = false;
                    ShowCaption = false;
            ...
            group(FirstPage)
            {
                ...
                group("Welcome")
                {
                    ...
                    group(Terms)
                    {
                        ...
                        {
                            Caption = '';
                            InstructionalText = 'By enabling the Customer Rewards extention...';
                            Visible = FirstPageVisible;
                        }
                    }
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(ActionActivate)
            {
                ...
                begin
                    if ActivationCode = '' then Error('Activation code cannot be blank.');
                    if Text.StrLen(ActivationCode) <> 14 then Error('Activation code must be 14 digits.');
